...
- All the pull requests closed since the latest release are associated to an issue. If necessary, create issues
  and assign them to the milestone. Also assign the person who opened the PR to the issue.
...
After the release is published on [public PyPI](https://pypi.org/project/deepecho/), Anacanoda will automatically open a [PR on conda-forge](https://github.com/conda-forge/deepecho-feedstock/pulls). Make sure the dependencies match and then merge the PR for the anaconda release to be published.
