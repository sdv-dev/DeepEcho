...
DeepEcho could always use more documentation, whether as part of the
official DeepEcho docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
Ready to contribute? Here's how to set up `DeepEcho` for local development.

1. Fork the `DeepEcho` repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/DeepEcho.git

3. Install your local copy into a virtualenv. Assuming you have virtualenvwrapper installed,
   this is how you set up your fork for local development::

    $ mkvirtualenv DeepEcho
    $ cd DeepEcho/
...
2. The tests that cover a module called ``deepecho/path/to/a_module.py``
   should be implemented in a separated module called
   ``tests/deepecho/path/to/test_a_module.py``.
...
To run a subset of tests::
    ...
    $ python -m pytest tests.test_deepecho
...
or in command line::
    ...
    pip install 'deepecho>=X.Y.Z.dev'


.. _GitHub issues page: https://github.com/sdv-dev/DeepEcho/issues
.. _Build Status page: https://github.com/sdv-dev/DeepEcho/actions
